...
function _G.toggle_diagnostics()
  if vim.g.diagnostics_active == true then
...
vim.keymap.set('n', '<leader>hd', vim.diagnostic.hide, {desc = 'Hide diagnostic messages'})

vim.keymap.set('n', '<leader>td', _G.toggle_diagnostics, {desc = 'Toggle diagnostic messages'})
